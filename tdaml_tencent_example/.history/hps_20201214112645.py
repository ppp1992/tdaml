...
models = {
    ...
    #     'weight_decay': hp.choice('weight_decay', [0, 1e-8, 1e-7, 1e-5]),
    #     'amsgrad': hp.choice('amsgrad', [False, True]),
    #     'batch_n_ID': hp.choice('batch_n_ID', [25, 50, 100, 200, 300, 400, 500]),
    #     'rho': hp.choice('rho', [0.00001, 0.00005, 0.0001, 0.0005, 0.001]),
    #     'p_lr': hp.choice('p_lr', [0.1, 0.001, 0.0001, 0.00001, 0.000001]),
    #     'p_lr_decay': hp.choice('p_lr_decay', [1.0, 0.5, 0.1, 0.05, 0.01]),
    #     'gamma': hp.choice('gamma', [1.0]),
    #     'alpha': hp.choice('alpha', [0.1, 0.2, 0.3, 0.5, 0.6, 0.7]),
    # },
    'WD': {
        'lr': hp.choice('lr', [0.01]),
